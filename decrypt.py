...
crypted_list = ['AQIvZ0rae6csEKp09v5UvJfWyehtBM3rtPHsRJIPVxHyyaZGy/v9xFnGv18=',
                'AQIn08cVW4SAPsqT4VdX24WeRh+WO/4lrMbh436HMSYRv0q09P0=',
                '''AQI5CFY7+Sq8DGq7XYD7X8EyXZcUOjWka2WETTgK1zOu6oAOwE1cParQ4KvMyV60FoH2AcJOErQ6
...
gQhr2zKXp2Mqx6mgREWIhfkpPEDoJuGEEHOR''',
                'AQL+SIyCOQTbwB84By9oa1NNruzfEO3xQMx/Qj5IQBWbPQ+w83nDf3vI1qo6CVvG9+ikvN4L3CcdrKq5lPnT1bE=']

for crypted_text in crypted_list:
    a = AES.new(key, AES.MODE_GCM, b64decode(crypted_text)[2:14])
    print(a.decrypt(b64decode(crypted_text)[14:]))
